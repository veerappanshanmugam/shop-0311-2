...
Generated at: 2026-03-11T18:49:09.270522+00:00
Project: shop-0311-2
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without providing email field",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without providing name field",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "List all users, returns an array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
