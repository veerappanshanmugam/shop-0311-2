...
Generated at: 2026-03-11T19:18:40.310603+00:00
Project: shop-0311-2
Milestone: 4
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "GET",
        "description": "Get sales report on empty database \u2014 all values should be zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Get inventory report on empty database \u2014 all values should be zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "product_performance_empty_db",
        "category": "HAPPY_PATH",
    ...
    {
        "name": "product_performance_with_data",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/products",
        "method": "GET",
    ...
    {
        "name": "product_performance_excludes_uncategorized",
        "category": "BOUNDARY",
        "endpoint": "/reports/products",
        "method": "GET",
    ...
    {
        "name": "category_performance_empty_db",
        "category": "HAPPY_PATH",
    ...
    {
        "name": "category_performance_with_data",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/categories",
        "method": "GET",
    ...
    {
        "name": "user_activity_with_orders",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/users",
        "method": "GET",
    ...
    {
        "name": "user_activity_user_with_no_orders",
        "category": "BOUNDARY",
        "endpoint": "/reports/users",
        "method": "GET",
