...
Generated at: 2026-03-11T18:34:14.986957+00:00
Project: shop-0311-2
Milestone: 2
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "POST",
        "description": "Create a category with only the required name field, no description",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "GET",
        "description": "Create a category then list all categories to verify it appears",
        "setup": {
            "endpoint": "/categories",
            "method": "POST",
            "body": {
    ...
    {
        "name": "list_categories_empty",
        "category": "HAPPY_PATH",
        "endpoint": "/categories",
        "method": "GET",
        "description": "List categories on a fresh database expecting an empty array or existing entries",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Create a product without a category (null category_id)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Attempt to create a product with a non-existent category_id, expect 404",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "name": "Ghost Product",
                "description": "Product with bad category",
                "price": 19.99,
                "category_id": 999999
            }
        },
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "GET",
        "description": "Create a product then list all products to verify it appears",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    {
        "name": "list_products_empty",
        "category": "HAPPY_PATH",
        "endpoint": "/products",
        "method": "GET",
        "description": "List products expecting a valid array response",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a product (which auto-creates inventory), then get inventory for that product",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/inventory/{productId}",
        "method": "GET",
        "description": "Attempt to get inventory for a non-existent product, expect 404",
        "request_data": {
            "path": {
                "productId": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/inventory/{productId}",
        "method": "PUT",
        "description": "Create a product, then update its inventory quantity to 100",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/inventory/{productId}/reserve",
        "method": "POST",
        "description": "Create a product (inventory starts at 0), attempt to reserve 5 units, expect 400 insufficient inventory",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
